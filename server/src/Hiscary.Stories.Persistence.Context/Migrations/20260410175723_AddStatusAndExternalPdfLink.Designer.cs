...
namespace Hiscary.Stories.Persistence.Context.Migrations
{
    ...
    [Migration("20260410175723_AddStatusAndExternalPdfLink")]
    partial class AddStatusAndExternalPdfLink
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hiscary.Stories.Domain.Stories.Story", b =>
                {
                    ...
                    b.Property<ExternalPdf>("ExternalPdf")
                        .HasColumnType("jsonb")
                        .HasColumnName("ExternalPdf");

                    b.Property<int>("ExternalPdfPageCount")
                        .HasColumnType("integer");
