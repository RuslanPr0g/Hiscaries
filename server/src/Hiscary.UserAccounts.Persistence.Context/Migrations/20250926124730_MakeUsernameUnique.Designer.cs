...
namespace Hiscary.UserAccounts.Persistence.Context.Migrations
{
    ...
    [Migration("20250926124730_MakeUsernameUnique")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hiscary.UserAccounts.Domain.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hiscary.UserAccounts.Domain.UserAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hiscary.UserAccounts.Domain.UserAccount", b =>
                {
                    b.HasOne("Hiscary.UserAccounts.Domain.RefreshToken", "RefreshToken")
                        .WithOne()
                        .HasForeignKey("Hiscary.UserAccounts.Domain.UserAccount", "RefreshTokenId")
