...
- Reuses shared fixture/helpers from `Hiscary.IntegrationTesting` for future microservice modules.
...
- Keep shared fixtures/helpers in `Hiscary.IntegrationTesting`.
